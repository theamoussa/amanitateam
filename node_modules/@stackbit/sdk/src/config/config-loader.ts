...
import { ModelsSource, Field, ModelExtension, FieldExtension, FieldType, DistributePartialListItems, FieldListItems } from '@stackbit/types';
import { append, fieldPathToString, getFirstExistingFile, prepend, rename } from '@stackbit/utils';
...
import type { Config, StackbitConfigWithPaths, SSGRunOptions, Model, PageModel, DataModel, DataModelSingle } from './config-types';
    ...
    for (const configModel of configModels) {
        ...
        mergedModel = mapModelFieldsRecursively(
            ...
            (externalField, modelKeyPath): Field => {
                ...
                const stackbitFieldProps: FieldExtension | DistributePartialListItems<FieldListItems> =
                    stackbitField.type === 'list' ? stackbitField.items ?? {} : stackbitField;
                ...
                externalField = mapListItemsPropsOrSelfSpecificProps(externalField, (externalFieldProps) => {
                    ...
                    switch (fieldType) {
                        ...
                        case 'style':
                            ...
                            break;
                        case 'object':
                            fieldSpecificProps = _.pick(stackbitFieldProps, ['labelField', 'thumbnail', 'fieldGroups']);
                            break;
                        case 'model':
