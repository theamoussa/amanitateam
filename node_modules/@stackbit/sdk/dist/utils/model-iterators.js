...
function iterateModelFieldsRecursively(model, iteratee) {
    ...
    function _iterateDeep({ fields, modelKeyPath }) {
        ...
        lodash_1.default.forEach(fields, (field) => {
            ...
            if (model_utils_1.isObjectField(field)) {
                _iterateDeep({
                    fields: field.fields,
                    modelKeyPath: childModelKeyPath
                });
            }
            else if (model_utils_1.isListField(field) && field.items && model_utils_1.isObjectListItems(field.items)) {
                _iterateDeep({
    ...
    if (model && model_utils_1.isListDataModel(model) && model.items && model_utils_1.isObjectListItems(model.items)) {
        _iterateDeep({
...
function mapModelFieldsRecursively(model, iteratee) {
    function _mapField(field, modelKeyPath) {
        ...
        else if (model_utils_1.isListField(field)) {
    ...
    function _mapListField(field, modelKeyPath) {
        ...
        if (!items || !model_utils_1.isObjectListItems(items)) {
            return field;
        }
        return {
            ...field,
    ...
    else if (model_utils_1.isListDataModel(model)) {
