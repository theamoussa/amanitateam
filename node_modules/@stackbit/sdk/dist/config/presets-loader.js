...
function extendModelsWithPresetsIds({ models, presets }) {
    ...
    for (const [presetId, preset] of Object.entries(presets)) {
        utils_1.append(presetsIdsByContentSourceAndModel, [preset.srcType, preset.srcProjectId, preset.modelName], presetId);
        utils_1.append(presetsIdsByModel_deprecated, preset.modelName, presetId);
    }
